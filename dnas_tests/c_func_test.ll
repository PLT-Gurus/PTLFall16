...
define i32 @main() {
entry:
  %test = call i32 (i32, i32, ...) bitcast (i32 (i32, i32)* @test to i32 (i32, i32, ...)*)(i32 2, i32 1)
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt_int, i32 0, i32 0), i32 %test)
  ret i32 0
}
