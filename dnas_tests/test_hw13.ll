...
entry:
  ...
  %hi2 = load i8*, i8** %hi
  %hello3 = load i8*, i8** %hello
  %hi4 = load i8*, i8** %hi
  %hello5 = load i8*, i8** %hello
  %concat = call i8* (i8*, i8*, ...) bitcast (i8* (i8*, i8*)* @concat to i8* (i8*, i8*, ...)*)(i8* %hi4, i8* %hello5)
  store i8* %concat, i8** %third
  %third6 = load i8*, i8** %third
  %third7 = load i8*, i8** %third
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @fmt_str, i32 0, i32 0), i8* %third7)
  ret i32 0
}
...
; <label>:70                                      ; preds = %51
  ...
  %73 = load i8*, i8** %retstr, align 8
  %74 = getelementptr inbounds i8, i8* %73, i64 %72
  store i8 0, i8* %74, align 1
  %75 = load i8*, i8** %retstr, align 8
  ret i8* %75
}
