...
@context = private unnamed_addr constant [14 x i8] c"sample2.FASTA\00"
...
entry:
  %temp = alloca i8*
  %readFile = call i8* (i8*, ...) bitcast (i8* (i8*)* @readFile to i8* (i8*, ...)*)(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @context, i32 0, i32 0))
  store i8* %readFile, i8** %temp
  %temp1 = load i8*, i8** %temp
  %temp2 = load i8*, i8** %temp
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @fmt_str, i32 0, i32 0), i8* %temp2)
  ret i32 0
}
