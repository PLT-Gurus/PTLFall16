...
@context.1 = private unnamed_addr constant [4 x i8] c"a-k\00"
@context.2 = private unnamed_addr constant [6 x i8] c"a-k-w\00"
...
entry:
  ...
  %r11 = alloca i8*
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @context.1, i32 0, i32 0), i8** %r11
  %p1 = alloca i8*
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @context.2, i32 0, i32 0), i8** %p1
  %r12 = load i8*, i8** %r11
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt_str, i32 0, i32 0), i8* %r12)
  %p13 = load i8*, i8** %p1
  %printf4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt_str, i32 0, i32 0), i8* %p13)
  ret i32 0
}
