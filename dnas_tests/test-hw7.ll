...
@context.2 = private unnamed_addr constant [4 x i8] c"agg\00"
@context.3 = private unnamed_addr constant [6 x i8] c"a-k-w\00"
...
entry:
  ...
  %r11 = alloca i8*
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @context.2, i32 0, i32 0), i8** %r11
  %p1 = alloca i8*
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @context.3, i32 0, i32 0), i8** %p1
  %i = alloca i32
  store i32 1, i32* %i
  %r12 = load i8*, i8** %r11
  %r13 = load i8*, i8** %r11
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt_str, i32 0, i32 0), i8* %r13)
  %p14 = load i8*, i8** %p1
  %p15 = load i8*, i8** %p1
  %printf6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt_str, i32 0, i32 0), i8* %p15)
  ret i32 0
}
