...
@context.2 = private unnamed_addr constant [4 x i8] c"boo\00"
...
entry:
  ...
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @context.2, i32 0, i32 0), i8** %hi
  %hi3 = load i8*, i8** %hi
  %printf4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt_str, i32 0, i32 0), i8* %hi3)
  ret i32 0
}
